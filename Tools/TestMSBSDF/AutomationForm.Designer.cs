namespace TestMSBSDF
{
	partial class AutomationForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.floatTrackbarControlParam2_Min = new Nuaj.Cirrus.Utility.FloatTrackbarControl();
			...
			this.floatTrackbarControlParam1_Min = new Nuaj.Cirrus.Utility.FloatTrackbarControl();
			...
			this.integerTrackbarControlParam0_Steps = new Nuaj.Cirrus.Utility.IntegerTrackbarControl();
			this.floatTrackbarControlParam0_Max = new Nuaj.Cirrus.Utility.FloatTrackbarControl();
			this.label4 = new System.Windows.Forms.Label();
			this.floatTrackbarControlParam0_Min = new Nuaj.Cirrus.Utility.FloatTrackbarControl();
			...
			this.radioButtonInit_TowardCoM = new System.Windows.Forms.RadioButton();
			this.radioButtonInit_TowardReflectedDirection = new System.Windows.Forms.RadioButton();
			this.panel3 = new System.Windows.Forms.Panel();
			this.floatTrackbarControlInit_CustomRoughness = new Nuaj.Cirrus.Utility.FloatTrackbarControl();
			this.radioButtonInit_UseSurfaceRoughness = new System.Windows.Forms.RadioButton();
			this.radioButtonInit_UseCustomRoughness = new System.Windows.Forms.RadioButton();
			this.label9 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.label11 = new System.Windows.Forms.Label();
			this.checkBoxInit_StartSmall = new System.Windows.Forms.CheckBox();
			...
			this.integerTrackbarControlScatteringOrder_Min = new Nuaj.Cirrus.Utility.IntegerTrackbarControl();
			this.integerTrackbarControlScatteringOrder_Max = new Nuaj.Cirrus.Utility.IntegerTrackbarControl();
        ...
        " be at (max-min) * 1 / StepsCount");
			...
			this.checkBoxParm2_InclusiveEnd.Checked = true;
			this.checkBoxParm2_InclusiveEnd.CheckState = System.Windows.Forms.CheckState.Checked;
        ...
        "e at (max-min) * (StepsCount-1)/StepsCount");
			...
			this.integerTrackbarControlParam2_Steps.Value = 10;
			...
			this.floatTrackbarControlParam2_Max.Value = 1F;
			...
			this.floatTrackbarControlParam2_Min.Value = 0F;
        ...
        "p will be at (max-min) * (StepsCount-1)/StepsCount");
			...
			// groupBox3
			// 
			this.groupBox3.Controls.Add(this.floatTrackbarControlInit_MaskingImportance);
			this.groupBox3.Controls.Add(this.panel4);
			this.groupBox3.Controls.Add(this.panel3);
			this.groupBox3.Controls.Add(this.label8);
			this.groupBox3.Controls.Add(this.label11);
			this.groupBox3.Controls.Add(this.checkBoxInit_StartSmall);
			this.groupBox3.Controls.Add(this.floatTrackbarControlInit_Flatten);
			this.groupBox3.Controls.Add(this.floatTrackbarControlInit_StartSmallFactor);
			...
			this.groupBox3.Text = "Initial Guesses";
			// 
			// floatTrackbarControlInit_MaskingImportance
			// 
			this.floatTrackbarControlInit_MaskingImportance.Location = new System.Drawing.Point(111, 181);
			...
			this.floatTrackbarControlInit_MaskingImportance.RangeMax = 1F;
			this.floatTrackbarControlInit_MaskingImportance.RangeMin = 0F;
			this.floatTrackbarControlInit_MaskingImportance.Size = new System.Drawing.Size(200, 20);
			...
			this.panel4.Controls.Add(this.radioButtonInit_TowardCoM);
			this.panel4.Controls.Add(this.radioButtonInit_TowardReflectedDirection);
			...
			this.label10.Text = "Orient toward";
			// 
			// radioButtonInit_TowardCoM
			// 
			this.radioButtonInit_TowardCoM.AutoSize = true;
			this.radioButtonInit_TowardCoM.Checked = true;
			this.radioButtonInit_TowardCoM.Location = new System.Drawing.Point(88, 2);
			this.radioButtonInit_TowardCoM.Name = "radioButtonInit_TowardCoM";
			this.radioButtonInit_TowardCoM.Size = new System.Drawing.Size(96, 17);
			this.radioButtonInit_TowardCoM.TabIndex = 0;
			this.radioButtonInit_TowardCoM.TabStop = true;
			this.radioButtonInit_TowardCoM.Text = "Center of Mass";
			this.toolTip1.SetToolTip(this.radioButtonInit_TowardCoM, "Initial orientation is aligned toward the Center of Mass of the simulated lobe (b" +
        "etter estimate)");
			this.radioButtonInit_TowardCoM.UseVisualStyleBackColor = true;
			// 
			// radioButtonInit_TowardReflectedDirection
			// 
			this.radioButtonInit_TowardReflectedDirection.AutoSize = true;
			this.radioButtonInit_TowardReflectedDirection.Location = new System.Drawing.Point(88, 25);
			this.radioButtonInit_TowardReflectedDirection.Name = "radioButtonInit_TowardReflectedDirection";
			this.radioButtonInit_TowardReflectedDirection.Size = new System.Drawing.Size(168, 17);
			this.radioButtonInit_TowardReflectedDirection.TabIndex = 0;
			this.radioButtonInit_TowardReflectedDirection.Text = "Reflected/Refracted Direction";
			this.toolTip1.SetToolTip(this.radioButtonInit_TowardReflectedDirection, "Initial orientation is aligned toward the reflected/refracted direction");
			this.radioButtonInit_TowardReflectedDirection.UseVisualStyleBackColor = true;
			this.radioButtonInit_TowardReflectedDirection.CheckedChanged += new System.EventHandler(this.radioButtonInit_UseCustomRoughness_CheckedChanged);
			// 
			// panel3
			// 
			this.panel3.Controls.Add(this.floatTrackbarControlInit_CustomRoughness);
			this.panel3.Controls.Add(this.radioButtonInit_UseSurfaceRoughness);
			this.panel3.Controls.Add(this.radioButtonInit_UseCustomRoughness);
			...
			this.floatTrackbarControlInit_CustomRoughness.Location = new System.Drawing.Point(108, 22);
			...
			// 
			// radioButtonInit_UseSurfaceRoughness
			// 
			this.radioButtonInit_UseSurfaceRoughness.AutoSize = true;
			this.radioButtonInit_UseSurfaceRoughness.Checked = true;
			this.radioButtonInit_UseSurfaceRoughness.Location = new System.Drawing.Point(88, 3);
			this.radioButtonInit_UseSurfaceRoughness.Name = "radioButtonInit_UseSurfaceRoughness";
			this.radioButtonInit_UseSurfaceRoughness.Size = new System.Drawing.Size(119, 17);
			this.radioButtonInit_UseSurfaceRoughness.TabIndex = 0;
			this.radioButtonInit_UseSurfaceRoughness.TabStop = true;
			this.radioButtonInit_UseSurfaceRoughness.Text = "Surface Roughness";
			this.radioButtonInit_UseSurfaceRoughness.UseVisualStyleBackColor = true;
			// 
			// radioButtonInit_UseCustomRoughness
			// 
			this.radioButtonInit_UseCustomRoughness.AutoSize = true;
			this.radioButtonInit_UseCustomRoughness.Location = new System.Drawing.Point(88, 26);
			this.radioButtonInit_UseCustomRoughness.Name = "radioButtonInit_UseCustomRoughness";
			this.radioButtonInit_UseCustomRoughness.Size = new System.Drawing.Size(14, 13);
			this.radioButtonInit_UseCustomRoughness.TabIndex = 0;
			this.radioButtonInit_UseCustomRoughness.UseVisualStyleBackColor = true;
			this.radioButtonInit_UseCustomRoughness.CheckedChanged += new System.EventHandler(this.radioButtonInit_UseCustomRoughness_CheckedChanged);
			// 
			// label9
			// 
			...
			this.label8.Text = "Start Flattened";
			this.toolTip1.SetToolTip(this.label8, "Specifies the lobe\'s flattening to start with (diffuse lobes tend to be flatter)");
			// 
			// label11
			// 
			this.label11.Location = new System.Drawing.Point(6, 178);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(111, 46);
			this.label11.TabIndex = 1;
			this.label11.Text = "Initial masking / shadowing importance";
			// 
			// checkBoxInit_StartSmall
			// 
			this.checkBoxInit_StartSmall.AutoSize = true;
			this.checkBoxInit_StartSmall.Checked = true;
			this.checkBoxInit_StartSmall.CheckState = System.Windows.Forms.CheckState.Checked;
			this.checkBoxInit_StartSmall.Location = new System.Drawing.Point(9, 75);
			this.checkBoxInit_StartSmall.Name = "checkBoxInit_StartSmall";
			this.checkBoxInit_StartSmall.Size = new System.Drawing.Size(76, 17);
			this.checkBoxInit_StartSmall.TabIndex = 4;
			this.checkBoxInit_StartSmall.Text = "Start Small";
			this.toolTip1.SetToolTip(this.checkBoxInit_StartSmall, "If checked, the lobe will start at a very small percentage of the size of the sim" +
        "ulated lobe (faster and better convergence rate)");
			this.checkBoxInit_StartSmall.UseVisualStyleBackColor = true;
			this.checkBoxInit_StartSmall.CheckedChanged += new System.EventHandler(this.checkBoxInit_StartSmall_CheckedChanged);
			// 
			// floatTrackbarControlInit_Flatten
			// 
			this.floatTrackbarControlInit_Flatten.Location = new System.Drawing.Point(111, 97);
			this.floatTrackbarControlInit_Flatten.MaximumSize = new System.Drawing.Size(10000, 20);
			this.floatTrackbarControlInit_Flatten.MinimumSize = new System.Drawing.Size(70, 20);
			this.floatTrackbarControlInit_Flatten.Name = "floatTrackbarControlInit_Flatten";
			this.floatTrackbarControlInit_Flatten.RangeMax = 10F;
			this.floatTrackbarControlInit_Flatten.RangeMin = 0F;
			this.floatTrackbarControlInit_Flatten.Size = new System.Drawing.Size(200, 20);
			this.floatTrackbarControlInit_Flatten.TabIndex = 2;
			...
			// 
			this.floatTrackbarControlInit_StartSmallFactor.Location = new System.Drawing.Point(111, 71);
        ...
        " initial lobes make simulation converge faster)");
			...
			this.radioButtonLobe_GGX.Location = new System.Drawing.Point(275, 3);
			...
			this.radioButtonLobe_Beckmann.Location = new System.Drawing.Point(193, 3);
			...
			this.radioButtonLobe_ModifiedPhong.Location = new System.Drawing.Point(88, 3);
		...
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlParam0_Min;
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlParam0_Max;
		...
		private System.Windows.Forms.CheckBox checkBoxInit_StartSmall;
		...
		private System.Windows.Forms.RadioButton radioButtonInit_UseSurfaceRoughness;
		private System.Windows.Forms.Label label9;
		private System.Windows.Forms.RadioButton radioButtonInit_UseCustomRoughness;
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlInit_CustomRoughness;
		private System.Windows.Forms.Panel panel4;
		private System.Windows.Forms.Label label10;
		private System.Windows.Forms.Panel panel3;
		private System.Windows.Forms.RadioButton radioButtonInit_TowardCoM;
		private System.Windows.Forms.RadioButton radioButtonInit_TowardReflectedDirection;
		private System.Windows.Forms.Label label11;
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlInit_MaskingImportance;
		private System.Windows.Forms.Panel panel5;
		private System.Windows.Forms.CheckBox checkBoxParam1_InclusiveEnd;
		private Nuaj.Cirrus.Utility.IntegerTrackbarControl integerTrackbarControlParam1_Steps;
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlParam1_Max;
		private System.Windows.Forms.Label label6;
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlParam1_Min;
		...
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlParam2_Min;
		...
		private Nuaj.Cirrus.Utility.IntegerTrackbarControl integerTrackbarControlScatteringOrder_Min;
		private System.Windows.Forms.Label label21;
		private Nuaj.Cirrus.Utility.IntegerTrackbarControl integerTrackbarControlScatteringOrder_Max;
		private System.Windows.Forms.Label label22;
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlGoalTolerance;
		private System.Windows.Forms.Label label23;
		private Nuaj.Cirrus.Utility.FloatTrackbarControl floatTrackbarControlGradientTolerance;
