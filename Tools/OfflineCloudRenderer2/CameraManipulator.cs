...
namespace OfflineCloudRenderer2
{
	...
	public class CameraManipulator
	{
		...
		public delegate void	UpdateCameraTransformEventHandler( float4x4 _Camera2World );
		...
		protected float2		m_ButtonDownMousePosition			= new float2( 0, 0 );
		...
		public event UpdateCameraTransformEventHandler		CameraTransformChanged = null;
		...
		protected float4x4	CameraTransform
		{
			...
			set
			{
			    ...
			    Result.r0 = new float4( -Result.r0.x, -Result.r0.y, -Result.r0.z, -Result.r0.w );

				CameraTransformChanged( Result );
			}
		}
		...
		public void		Attach( Control _Control )
		{
			m_Control = _Control;
