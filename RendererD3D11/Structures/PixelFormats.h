...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color )	{ PixelFormatRGBA16F& P = reinterpret_cast<PixelFormatRGBA16F&>( _Pixel ); P.R = _Color.x; P.G = _Color.y; P.B = _Color.z; P.A = _Color.w; }
		virtual NjFloat4	Read( PixelFormat& _Pixel ) const						{ PixelFormatRGBA16F& P = reinterpret_cast<PixelFormatRGBA16F&>( _Pixel ); return NjFloat4( P.R, P.G, P.B, P.A ); }
	} DESCRIPTOR;
