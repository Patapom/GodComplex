...
public: // PROPERTIES
	...
	virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const = 0;
...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const	{ PixelFormatRGBA8& P = (PixelFormatRGBA8&)( _Pixel ); P.R = FLOAT2BYTE( _Color.x ); P.G = FLOAT2BYTE( _Color.y ); P.B = FLOAT2BYTE( _Color.z ); P.A = FLOAT2BYTE( _Color.w ); }
...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const	{ PixelFormatRGBA8_sRGB& P = (PixelFormatRGBA8_sRGB&)( _Pixel ); P.R = FLOAT2BYTE( _Color.x ); P.G = FLOAT2BYTE( _Color.y ); P.B = FLOAT2BYTE( _Color.z ); P.A = FLOAT2BYTE( _Color.w ); }
...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const	{ PixelFormatRGBA16F& P = (PixelFormatRGBA16F&)( _Pixel ); P.R = _Color.x; P.G = _Color.y; P.B = _Color.z; P.A = _Color.w; }
...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const	{ PixelFormatRG16F& P = (PixelFormatRG16F&)( _Pixel ); P.R = _Color.x; P.G = _Color.y; }
		virtual NjFloat4	Read( const PixelFormat& _Pixel ) const						{ const PixelFormatRG16F& P = (const PixelFormatRG16F&)( _Pixel ); return NjFloat4( P.R, P.G, 0, 0 ); }
	} DESCRIPTOR;
...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const	{ PixelFormatRGBA16_UINT& P = (PixelFormatRGBA16_UINT&)( _Pixel ); P.R = U16( 65535.0f * _Color.x ); P.G = U16( 65535.0f * _Color.y ); P.B = U16( 65535.0f * _Color.z ); P.A = U16( 65535.0f * _Color.w ); }
...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const	{ PixelFormatRGBA32F& P = (PixelFormatRGBA32F&)( _Pixel ); P.R = _Color.x; P.G = _Color.y; P.B = _Color.z; P.A = _Color.w; }
		virtual NjFloat4	Read( const PixelFormat& _Pixel ) const						{ const PixelFormatRGBA32F& P = (const PixelFormatRGBA32F&)( _Pixel ); return NjFloat4( P.R, P.G, P.B, P.A ); }
	} DESCRIPTOR;
...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const	{ PixelFormatR32F& P = (PixelFormatR32F&)( _Pixel ); P.R = _Color.x; }
...
public:
	...
	public:
		...
		virtual void		Write( PixelFormat& _Pixel, const NjFloat4& _Color ) const	{ PixelFormatR16_UINT& P = (PixelFormatR16_UINT&)( _Pixel ); P.R = U16( 65535.0f * _Color.x ); }
