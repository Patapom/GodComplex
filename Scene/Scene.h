...
public:		// NESTED TYPES
	...
	private:
		Node( Node* _pParent, const U8*& _pData, const ISceneTagger& _SceneTagger );
		~Node();

		void			ClearTags( const ISceneTagger& _SceneTagClearer );

		virtual void	LoadSpecific( const U8*& _pData )	{}
		virtual void	ClearTagSpecific( const ISceneTagger& _SceneTagClearer )	{}
	...
	private:
		...
		Light( Node* _pParent, const U8*& _pData, const ISceneTagger& _SceneTagger );
		~Light();
	...
	private:
		...
		Camera( Node* _pParent, const U8*& _pData, const ISceneTagger& _SceneTagger );
		~Camera();
	...
	private:
		...
		virtual void	LoadSpecific( const U8*& _pData ) override;
		virtual void	ClearTagSpecific( const ISceneTagger& _SceneTagClearer ) override;
	...
	private:
		...
		Material( const U8*& _pData, const ISceneTagger& _Tagger );
