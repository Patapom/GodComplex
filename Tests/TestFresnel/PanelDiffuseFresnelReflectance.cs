...
{
	public partial class PanelDiffuseFresnelReflectance : Panel
	{
...
//		private const float	MAX_IOR = 10.0f;	// Maximum plotted IOR
		...
		public PanelDiffuseFresnelReflectance()
		{
			InitializeComponent();
		}

		public PanelDiffuseFresnelReflectance( IContainer container )
		{
			container.Add( this );
