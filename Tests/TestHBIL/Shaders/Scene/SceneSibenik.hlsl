...
//	result.diffuse += irradianceDirect;
	...
	LightInfoPoint	lightInfo2;
					...
					lightInfo2.flux = _sunIntensity * 250.0 * GetShadowPoint( _wsPosition, _wsNormal, _pixelSize_m, lightInfo2.wsPosition, lightInfo2.distanceAttenuation.y, _tex_ShadowMap, _noise, SHADOW_BIAS );
