...
float	mipLevel = 0.0;
		...
		sumRadiance += SampleIrradiance_TEMP( ssPosition_Back, radius_meters, float2( -_sinCosGamma.x, _sinCosGamma.y ), _centralZ, mipLevel, integralFactors_Back, previousRadianceBack, maxCosTheta_Back );
	}
//*/
