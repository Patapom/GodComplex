namespace TestFilmicCurve
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.tabPageCustom.Controls.Add(this.checkBoxLuminanceOnly);
			...
			// 
			this.checkBoxLuminanceOnly.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.checkBoxLuminanceOnly.AutoSize = true;
			this.checkBoxLuminanceOnly.Location = new System.Drawing.Point(9, 178);
			this.checkBoxLuminanceOnly.Name = "checkBoxLuminanceOnly";
			this.checkBoxLuminanceOnly.Size = new System.Drawing.Size(140, 17);
			this.checkBoxLuminanceOnly.TabIndex = 6;
			this.checkBoxLuminanceOnly.Text = "Work on luminance only";
			this.checkBoxLuminanceOnly.UseVisualStyleBackColor = true;
			this.checkBoxLuminanceOnly.Visible = false;
			// 
			...
			// 
			// checkBoxLogLuminance
			// 
			this.checkBoxLogLuminance.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.checkBoxLogLuminance.AutoSize = true;
			this.checkBoxLogLuminance.Location = new System.Drawing.Point(1399, 554);
			this.checkBoxLogLuminance.Name = "checkBoxLogLuminance";
			this.checkBoxLogLuminance.Size = new System.Drawing.Size(121, 17);
			this.checkBoxLogLuminance.TabIndex = 6;
			this.checkBoxLogLuminance.Text = "Show log-luminance";
			...
			this.panelOutput.DoubleClick += new System.EventHandler(this.panelOutput_DoubleClick);
			// 
			...
			this.outputPanelFilmic_Insomniac.ShowLogLuminance = false;
			...
			this.panelGraph_Hable.Location = new System.Drawing.Point(1131, 325);
			...
			this.panelGraph_Hable.ShowLogLuminance = false;
