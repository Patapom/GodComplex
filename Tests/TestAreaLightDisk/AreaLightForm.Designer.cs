namespace AreaLightTest
{
	partial class AreaLightForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.floatTrackbarControlLightScaleY = new UIUtility.FloatTrackbarControl();
			...
			this.floatTrackbarControlViewAngle = new UIUtility.FloatTrackbarControl();
		...
		private UIUtility.FloatTrackbarControl floatTrackbarControlLuminance;
		...
		private UIUtility.FloatTrackbarControl floatTrackbarControlLightScaleY;
		...
		private UIUtility.FloatTrackbarControl floatTrackbarControlViewAngle;
