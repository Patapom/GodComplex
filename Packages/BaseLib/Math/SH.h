...
public:
	...
	static double		ComputeSHCoeff( int l, int m, const bfloat3& _Direction );
	...
	static void			BuildSHCoeffs( const bfloat3& _Direction, double _Coeffs[9] );
	...
	static void			Product3( const bfloat3 a[9], const float b[9], bfloat3 r[9] );
	static void			Product3( const bfloat3 a[9], const bfloat3 b[9], bfloat3 r[9] );

	// Helpers
	static void			CartesianToSpherical( const bfloat3& _Direction, double& _θ, double& _ϕ );
	static bfloat3		SphericalToCartesian( double _θ, double _ϕ );
	static void			SphericalToCartesian( double _θ, double _ϕ, bfloat3& _Direction );
	static bfloat3		Yup2Zup( const bfloat3& _Yup );
	...
	static void			FilterHanning( bfloat3 _SH[9], float w );	// Applies a Hanning window of width w (usually the SH order).
	static void			FilterLanczos( bfloat3 _SH[9], float w );	// Applies a Lanczos window of width w (usually the SH order).
	static void			FilterGaussian( bfloat3 _SH[9], float w );	// Applies a Gaussian window of width w (usually the SH order).
	...
	//	Z
	//
	static void			BuildSHCoeffs_YUp( const bfloat3& _Direction, double _Coeffs[9] );
	static void			BuildSHCosineLobe_YUp( const bfloat3& _Direction, double _Coeffs[9] );
	static void			BuildSHCone_YUp( const bfloat3& _Direction, float _HalfAngle, double _Coeffs[9] );
	static void			BuildSHSmoothCone_YUp( const bfloat3& _Direction, float _HalfAngle, double _Coeffs[9] );
	static void			ZHRotate_YUp( const bfloat3& _Direction, const bfloat3& _ZHCoeffs, double _Coeffs[9] );
...
private:
	...
	static void			Filter( bfloat3 _SH[9], int l, float a );	// Modulate all coefficients of degree l by scalar a.
};
