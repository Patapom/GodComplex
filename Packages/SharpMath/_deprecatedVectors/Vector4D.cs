...
namespace SharpMath
{
    ...
    public class Vector4D
	{
		...
		public						Vector4D( float3 _Source )							{ Set( _Source ); }
		public						Vector4D( float3 _Source, float _w )				{ Set( _Source, _w ); }
		...
		public void					Set( float3 _Source )							{ x = _Source.x; y = _Source.y; z = _Source.z; w = 0.0f; }
		public void					Set( float3 _Source, float _w )					{ x = _Source.x; y = _Source.y; z = _Source.z; w = _w; }
		...
		public static explicit		operator float3( Vector4D _Source )				{ return new float3( _Source ); }
		...
		public static Vector4D		operator*( Vector4D _Op0, float4x4 _Op1 )
		{
		...
		public static Vector4D		operator*( float4x4 _Op0, Vector4D _Op1 )
		{
