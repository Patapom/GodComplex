...
namespace WMath
{
    ...
    public class Point4D
	{
		...
		public						Point4D( Point _Source )							{ Set( _Source ); }
		...
		public void					Set( Point _Source )							{ x = _Source.x; y = _Source.y; z = _Source.z; w = 1.0f; }
		...
		public static explicit		operator Point( Point4D _Source )				{ return new Point( _Source ); }
		...
		public static Point4D			operator*( Point4D _Op0, Matrix4x4 _Op1 )
		{
		...
		public static Point4D		operator*( Matrix4x4 _Op0, Point4D _Op1 )
		{
