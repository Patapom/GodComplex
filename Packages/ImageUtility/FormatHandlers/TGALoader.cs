...
namespace ImageUtility
{
    ...
    public class TargaImage : IDisposable
    {
		...
		public class TargaExtensionArea
		{
			...
			System.Drawing.Color cKeyColor = System.Drawing.Color.Empty;
			...
			internal protected void SetKeyColor(System.Drawing.Color cKeyColor)
			{
		...
		static class Utilities
		{
			...
			/// </remarks>
			internal static System.Drawing.Color GetColorFrom2Bytes(byte one, byte two)
			{
        ...
        private System.Drawing.Bitmap bmpTargaImage = null;
        private System.Drawing.Bitmap bmpImageThumbnail = null;
        ...
        public TargaImage( string strFileName, bool _ReadHeaderOnly ) : this()
        {
            ...
            if (System.IO.Path.GetExtension(strFileName).ToLower() == ".tga")
            {
                ...
                if (System.IO.File.Exists(strFileName) == true)
                {
                    ...
                    byte[] filebytes = System.IO.File.ReadAllBytes(this.strFileName);
            ...
            if (binReader != null && binReader.BaseStream != null && binReader.BaseStream.Length > 0 && binReader.BaseStream.CanSeek == true)
            {
                ...
                if (this.objTargaFooter.ExtensionAreaOffset > 0)
                {
                    try
                    {
                        ...
                        this.objTargaExtensionArea.SetKeyColor(System.Drawing.Color.FromArgb(a, r, g, b));
                        ...
                        if (this.objTargaExtensionArea.ColorCorrectionOffset > 0)
                        {
                            ...
                            for (int i = 0; i < TargaConstants.ExtensionAreaColorCorrectionTableValueLength; i++)
                            {
                                ...
                                this.objTargaExtensionArea.ColorCorrectionTable.Add(System.Drawing.Color.FromArgb(a, r, g, b));
                            }
                        }
                    }
                    catch (Exception ex)
        ...
        private void LoadTGAImage(BinaryReader binReader)
        {
            ...
            this.bmpTargaImage = new System.Drawing.Bitmap((int)this.objTargaHeader.Width,
            ...
            if (this.objTargaHeader.ColorMap.Count > 0)
            {
                ...
                for (int i = 0; i < this.objTargaHeader.ColorMap.Count; i++)
                {
                    ...
                    if (this.objTargaExtensionArea.AttributesType == 0 ||
                        ...
                        pal.Entries[i] = System.Drawing.Color.FromArgb(255, this.objTargaHeader.ColorMap[i].R, this.objTargaHeader.ColorMap[i].G, this.objTargaHeader.ColorMap[i].B);
            ...
            if (binReader != null && binReader.BaseStream != null && binReader.BaseStream.Length > 0 && binReader.BaseStream.CanSeek == true)
            {
                if (this.ExtensionArea.PostageStampOffset > 0)
                {
                    ...
                    if (data != null && data.Length > 0)
                    {
                        ...
                        this.bmpImageThumbnail = new System.Drawing.Bitmap(iWidth, iHeight, iStride, pfPixelFormat,
