...
namespace SharpMath
{
    ...
    public class Vector2D
	{
		...
		public						Vector2D( float3 _Source )						{ Set( _Source ); }
		public						Vector2D( float4 _Source )					{ Set( _Source ); }
		...
		public void					Set( float4 _Source )							{ x = _Source.x; y = _Source.y; }
		...
		// Cast operators
		public static explicit		operator float3( Vector2D _Source )				{ return new float3( _Source ); }
		public static explicit		operator float4( Vector2D _Source )			{ return new float4( _Source ); }
		...
		public static float3		operator^( Vector2D _Op0, Vector2D _Op1 )		{ return new float3( 0.0f, 0.0f, _Op0.x * _Op1.y - _Op0.y * _Op1.x ); }
