...
namespace ImageUtilityLib {
	...
	class	WPFMetaData {
	public:
		void	EnumerateMetaDataJPG( BitmapMetadata _MetaData, bool& _profileFound, bool& _gammaWasSpecified ) {
...
// 					} )
		...
		void	EnumerateMetaDataPNG( BitmapMetadata _MetaData, bool& _profileFound, bool& _gammaWasSpecified ) {
		...
		void	EnumerateMetaDataTIFF( BitmapMetadata _MetaData, bool& _profileFound, bool& _gammaWasSpecified ) {
			bool	bGammaWasSpecified = false;
			bool	bProfileFound = false;
