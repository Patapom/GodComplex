...
struct  NuajAtmosphereSupport 
{
	...
	NjITextureView* _SkyDensityTexture;
	...
	NjITextureView* _DeepShadowMapLayer00;				  // 2 layers of deep shadow map (up to 8 opacity values)
	NjITextureView* _DeepShadowMapLayer01;
};